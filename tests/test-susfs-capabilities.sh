...
SUSAF_FAKE_KSU_CHECK=unsupported
SUSAF_FAKE_FEATURES='CONFIG_KSU_SUSFS_SUS_PATH CONFIG_KSU_SUSFS_SUS_MOUNT CONFIG_KSU_SUSFS_TRY_UMOUNT CONFIG_KSU_SUSFS_SUS_SU'
SUSAF_FAKE_HELP='add_sus_path add_sus_path_loop add_sus_mount add_try_umount hide_sus_mnts_for_non_su_procs enable_avc_log_spoofing'
export SUSAF_FAKE_VERSION SUSAF_FAKE_VARIANT SUSAF_FAKE_KSU_CHECK SUSAF_FAKE_FEATURES SUSAF_FAKE_HELP
reset_capability_cache
